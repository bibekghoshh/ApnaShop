...
const Sponsored = () => {
  return (
    <div
      className={`hidden sm:flex bg-gray-50 py-10 px-5  cursor-pointer rounded-xl justify-center`}
    >
      <div className="flex justify-between w-[90%] bg-white py-5 px-5 rounded-md shadow-sm">
